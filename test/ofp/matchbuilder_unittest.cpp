...
TEST(matchbuilder, randomOrder) {
  ...
  EXPECT_HEX("80000A02:0800 80001401:01 80002601:00 80000606:0E33093BF893 80001804:0A000002 80002801:00 80001604:0A0A0A01 80000806:0E0000000001", match.data(), match.size());
  EXPECT_TRUE(match.validate());
}
