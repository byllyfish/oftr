...
TEST(requestforward, test) {
    ...
    EXPECT_HEX("050F0030000000011111220033333333002044445555555566666666000000000000001001010101AAAA000000000000", channel.data(), channel.size());
    ...
    EXPECT_HEX("0520003800000002050F0030000000011111220033333333002044445555555566666666000000000000001001010101AAAA000000000000", channel.data(), channel.size());
    ...
    EXPECT_HEX("050F0030000000011111220033333333002044445555555566666666000000000000001001010101AAAA000000000000", req.data(), req.size());
