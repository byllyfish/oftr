...
TEST(matchpacketbuilder, minimal_arp) {
  ...
  EXPECT_HEX(
      "000000000000000000000000080600010800060400000000000000000000000000000000000000000000",
      data.data(), data.size());

  MatchPacket decode{data};
  OXMRange range = decode.toRange();
  EXPECT_HEX("800006060000000000008000080600000000000080000A02080680002A02000080002C040000000080002E04000000008000300600000000000080003206000000000000", range.data(), range.size());
}
...
TEST(matchpacketbuilder, minimal_lldp) {
  ...
  EXPECT_HEX(
      "00000000000000000000000088CC0200040006020000",
      data.data(), data.size());

  MatchPacket decode{data};
  OXMRange range = decode.toRange();
  EXPECT_HEX("", range.data(), range.size());
}
