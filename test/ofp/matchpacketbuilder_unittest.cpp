...
TEST(matchpacketbuilder, arp) {
    ...
    EXPECT_HEX("00000000000200000000000108060001080006040001000000000001C0A80101000000000002C0A80102", data.data(), data.size());
...
TEST(matchpacketbuilder, vlan_arp) {
    ...
    EXPECT_HEX("0000000000020000000000018100 E0010806 0001080006040001000000000001C0A80101000000000002C0A80102", data.data(), data.size());
...
TEST(matchpacketbuilder, lldp) {
    ...
    EXPECT_HEX("00000000000200000000000188CC 020701001122334455 0403020102 06020045", data.data(), data.size());
