...
TEST(matchpacketbuilder, icmpv6_nd_solicit) {
  ...
  OXMRange range = decode.toRange();
  EXPECT_HEX(
      "800006060000000000028000080600000000000180000A0286DD80001001008000120100"
      "00013A0140800014013A8000341020000000000000000000000000000001800036102000"
      "0000000000000000000000000002800038040000000080003A018780003C010080003E10"
      "200000000000000000000000000000028000400600000000000180004E020001",
      range.data(), range.size());
}
...
TEST(matchpacketbuilder, icmpv6_nd_advertise) {
  ...
  EXPECT_HEX(
      "800006060000000000028000080600000000000180000A0286DD80001001008000120100"
      "00013A0140800014013A8000341020000000000000000000000000000001800036102000"
      "0000000000000000000000000002800038040000000080003A018880003C0100FFFF0A08"
      "00FFFFFF7001020380003E10200000000000000000000000000000028000420600000000"
      "000280004E020001",
      range.data(), range.size());
}
