...
TEST(matchpacketbuilder, lldp) {
  ...
  EXPECT_HEX(
      ...
      "0000000000000000000000000000000000000000000000000000FFFF060600FFFFFF004"
      "5",
      range.data(), range.size());
}

TEST(matchpacketbuilder, lldp_custom) {
  MacAddress ethSrc{"00:00:00:00:00:01"};
  MacAddress ethDst{"00:00:00:00:00:02"};
  ...
  LLDPValue<LLDPType::ChassisID> chassisID;
  EXPECT_TRUE(chassisID.parse("mac 0E0000001001"));
  oxm.add(X_LLDP_CHASSIS_ID{chassisID});
  ...
  EXPECT_HEX(
      "00000000000200000000000188CC0207040E000000100104020531060200030A0B53797374656D5F4E414D45080A506F72745F4445534352FE080012BB02014065000000",
      data.data(), data.size());

  MatchPacket decode{data};
  OXMRange range = decode.toRange();
  EXPECT_HEX(
      "",
      range.data(), range.size());
}
