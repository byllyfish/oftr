...
TEST(lldpvalue, chassisID) {
  ...
  EXPECT_TRUE(value.parse("local 001122334455"));
  EXPECT_HEX("07001122334455", value.data(), value.size());
  EXPECT_EQ("local 001122334455", value.toString());
}
