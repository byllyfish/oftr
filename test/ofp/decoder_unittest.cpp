...
TEST(decoder, ofmp_flowreply2_v4) {
  testDecodeEncode(
      ...
      "idle_timeout:    0x0055\n      hard_timeout:    0x0066\n      flags:    "
      "       [ SEND_FLOW_REM, CHECK_OVERLAP, RESET_COUNTS, NO_BYT_COUNTS, "
...
TEST(decoder, portmodv5) {
  testDecodeEncode("051000780000000000000001000000000011000011110000000000000000000000000008000010000001001800000003000005DC000007D000000BB80000012CFFFF000C000000650000000000000000FFFF0010000000650000000100000001FFFF00140000006500000002000000010000000200000000", "---\ntype:            PORT_MOD\nxid:             0x00000000\nversion:         0x05\nmsg:             \n  port_no:         0x00000001\n  hw_addr:         '00:11:00:00:11:11'\n  config:          [  ]\n  mask:            [  ]\n  ethernet:        \n    advertise:       [ FIBER ]\n  optical:         \n    configure:       [ RX_TUNE, TX_TUNE ]\n    freq_lmda:       0x000005DC\n    fl_offset:       2000\n    grid_span:       0x00000BB8\n    tx_pwr:          0x0000012C\n  properties:      \n    - property:        0xFFFF\n      experimenter:    0x00000065\n      exp_type:        0x00000000\n      data:            ''\n    - property:        0xFFFF\n      experimenter:    0x00000065\n      exp_type:        0x00000001\n      data:            00000001\n    - property:        0xFFFF\n      experimenter:    0x00000065\n      exp_type:        0x00000002\n      data:            0000000100000002\n...\n");
}
...
TEST(decoder, ofmp_groupfeatures_reply) {
  testDecodeEncode(
      ...
      "actions_all:     [ OUTPUT, SET_VLAN_VID, SET_VLAN_PCP, SET_DL_DST, "
      "SET_NW_SRC, SET_NW_DST, SET_NW_ECN, SET_TP_SRC, SET_TP_DST, "
      "COPY_TTL_IN, SET_MPLS_LABEL, SET_MPLS_TC, DEC_MPLS_TTL, PUSH_VLAN, "
      "POP_VLAN, POP_MPLS, SET_QUEUE, GROUP, DEC_NW_TTL, SET_FIELD, PUSH_PBB, "
      "'0x30000000' ]\n    actions_sel:     [ SET_DL_SRC, SET_NW_TOS, "
      "COPY_TTL_OUT, SET_MPLS_TTL, PUSH_MPLS, SET_NW_TTL, POP_PBB ]\n    "
      "actions_ind:     [ OUTPUT, SET_DL_SRC, SET_DL_DST, SET_NW_TOS, "
      "SET_NW_ECN, COPY_TTL_OUT, COPY_TTL_IN, SET_MPLS_TTL, DEC_MPLS_TTL, "
      "PUSH_MPLS, POP_MPLS, SET_NW_TTL, DEC_NW_TTL, POP_PBB, '0x10000000' ]\n  "
      "  actions_ff:      [ SET_VLAN_VID, SET_DL_SRC, SET_NW_SRC, SET_NW_TOS, "
      "SET_TP_SRC, COPY_TTL_OUT, SET_MPLS_LABEL, SET_MPLS_TTL, PUSH_VLAN, "
...
TEST(decoder, multipartreply_portdescv4) {
  testDecodeEncode("", "---\ntype:            MULTIPART_REPLY\nxid:             0x00000000\nversion:         0x04\nmsg:             \n  type:            PORT_DESC\n  flags:           [  ]\n  body:            \n    - port_no:         0x00000007\n      hw_addr:         'f2:0b:a4:d0:3f:70'\n      name:            Port7\n      config:          [  ]\n      state:           [ LIVE ]\n      ethernet:        \n        curr:            [ 100MB_FD, COPPER, AUTONEG ]\n        advertised:      [ COPPER, AUTONEG ]\n        supported:       [ 100MB_FD, COPPER, AUTONEG ]\n        peer:            [ 100MB_FD, COPPER, AUTONEG ]\n        curr_speed:      0x00001388\n        max_speed:       0x00001388\n      properties:      \n    - port_no:         0x00000006\n      hw_addr:         'f2:0b:a4:7d:f8:ea'\n      name:            Port6\n      config:          [  ]\n      state:           [ LIVE ]\n      ethernet:        \n        curr:            [ 100MB_FD, COPPER, AUTONEG ]\n        advertised:      [ COPPER, AUTONEG ]\n        supported:       [ 100MB_FD, COPPER, AUTONEG ]\n        peer:            [ 100MB_FD, COPPER, AUTONEG ]\n        curr_speed:      0x00001388\n        max_speed:       0x00001388\n      properties:      \n...\n");
}
