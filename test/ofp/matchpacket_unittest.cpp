...
TEST(matchpacket, ipv6_unknown_ip_proto) {
  // The current implementation doesn't add IP_PROTO if it's not TCP, UDP or
  // ICMPv6.
  testPacket(
...
TEST(matchpacket, tcp6_with_hopbyhop_routing_ext_hdrs) {
  ...
  // |<IPv6ExtHdrHopByHop  nh=Routing Header |<IPv6ExtHdrRouting  nh=TCP |<TCP
  // sport=2 dport=1 flags=S |>>>>>
  testPacket(
      "FFFFFFFFFFFF00000000000086DD60000000002400400000000000000000000000000000"
      "0001000000000000000000000000000000012B0001040000000006000000000000000002"
      "00010000000000000000500220008FDE0000",
      "---\n- field:           ETH_DST\n  value:           "
      "'ff:ff:ff:ff:ff:ff'\n- field:           ETH_SRC\n  value:           "
      "'00:00:00:00:00:00'\n- field:           ETH_TYPE\n  value:           "
      "0x86DD\n- field:           NX_IP_TTL\n  value:           0x40\n- field: "
...
TEST(matchpacket, sctp6_with_hopbyhop_routing_ext_hdrs) {
  // <Ether  type=0x86dd |<IPv6  nh=Hop-by-Hop Option Header
  // |<IPv6ExtHdrHopByHop  nh=Routing Header |<IPv6ExtHdrRouting  nh=SCTP |<SCTP
  // sport=1 dport=2 |>>>>>
  // FIXME(bfish): IP_PROTO is missing
  testPacket(
      "FFFFFFFFFFFF00000000000086DD60000000001C00400000000000000000000000000000"
      "0001000000000000000000000000000000012B0001040000000084000000000000000001"
      "000200000000FD988051",
      "---\n- field:           ETH_DST\n  value:           "
      "'ff:ff:ff:ff:ff:ff'\n- field:           ETH_SRC\n  value:           "
      "'00:00:00:00:00:00'\n- field:           ETH_TYPE\n  value:           "
      "0x86DD\n- field:           NX_IP_TTL\n  value:           0x40\n- field: "
...
TEST(matchpacket, ipv6_with_hopbyhop_routing_ext_hdrs_only) {
  // <Ether  type=0x86dd |<IPv6  nh=Hop-by-Hop Option Header
  // |<IPv6ExtHdrHopByHop  nh=Routing Header |<IPv6ExtHdrRouting  nh=No Next
  // Header |>>>>
  testPacket(
      "FFFFFFFFFFFF00000000000086DD60000000001000400000000000000000000000000000"
      "0001000000000000000000000000000000012B000104000000003B00000000000000",
      "---\n- field:           ETH_DST\n  value:           "
      "'ff:ff:ff:ff:ff:ff'\n- field:           ETH_SRC\n  value:           "
      "'00:00:00:00:00:00'\n- field:           ETH_TYPE\n  value:           "
      "0x86DD\n- field:           NX_IP_TTL\n  value:           0x40\n- field: "
...
TEST(matchpacket, ipv6_nonext_hdr_only) {
  ...
  testPacket(
      "FFFFFFFFFFFF00000000000086DD6000000000003B400000000000000000000000000000"
      "000100000000000000000000000000000001",
      "---\n- field:           ETH_DST\n  value:           "
      "'ff:ff:ff:ff:ff:ff'\n- field:           ETH_SRC\n  value:           "
      "'00:00:00:00:00:00'\n- field:           ETH_TYPE\n  value:           "
      "0x86DD\n- field:           NX_IP_TTL\n  value:           0x40\n- field: "
...
TEST(matchpacket, ipv6_exthdr_incomplete) {
  // <Ether  type=0x86dd |<IPv6  nh=Hop-by-Hop Option Header |>>
  testPacket(
      "FFFFFFFFFFFF00000000000086DD60000000000000400000000000000000000000000000"
      "000100000000000000000000000000000001",
      "---\n- field:           ETH_DST\n  value:           "
      "'ff:ff:ff:ff:ff:ff'\n- field:           ETH_SRC\n  value:           "
      "'00:00:00:00:00:00'\n- field:           ETH_TYPE\n  value:           "
