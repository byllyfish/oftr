...
TEST(rolereply, test) {
  ...
  EXPECT_HEX("041800180000000100000001000000000000000000000001",
             channel1.data(), channel1.size());
  ...
  EXPECT_HEX("041900180000000100000001000000000000000000000001",
             channel2.data(), channel2.size());
}
