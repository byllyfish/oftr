...
TEST(ybyteorder, Big32) {
    Big32 value;
    llvm::StringRef err = llvm::yaml::ScalarTraits<Big32>::input("0x01020304", nullptr, value);
    EXPECT_EQ("", err);
...
TEST(ybyteorder, Big24) {
    Big24 value;
    llvm::StringRef err = llvm::yaml::ScalarTraits<Big24>::input("0x010203", nullptr, value);
    EXPECT_EQ("", err);
