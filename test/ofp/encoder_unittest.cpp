...
TEST(encoder, packetinv4_pkt) {
  ...
  EXPECT_HEX(
      "040A0076000000013333333044400180999999999999999000010020800000045555555080000204666666608000040877777777777777700000FFFFFFFFFFFF000000000001080600010800060400010000000000010A0000010000000000000A000002000000000000000000000000000000000000",
      encoder.data(), encoder.size());
}
...
TEST(encoder, packetinv4_pkt_no_total_len) {
  ...
  EXPECT_EQ(0x076, encoder.size());
  EXPECT_HEX(
      "040A00760000000133333330003C0180999999999999999000010020800000045555555080000204666666608000040877777777777777700000FFFFFFFFFFFF000000000001080600010800060400010000000000010A0000010000000000000A000002000000000000000000000000000000000000",
      encoder.data(), encoder.size());
}
