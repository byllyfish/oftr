...
TEST(encoder, ofmp_flowreply_v1) {
  ...
  EXPECT_HEX(
      "0111006C111111110001222200603300003FFFFEDDDD0000000000000000000000000000"
...
TEST(encoder, ofmp_flowreply2_v1) {
  ...
  testEncoderSuccess(
      input, 0x0CC,
      "011100CC112233440001000000600100003FFFFE56780000000000000000000000000000"
      ...
      "00601100003FFFF30000102030405060AABBCCDDEEFF0000000000000000000000000000"
...
TEST(encoder, flowmodv1) {
  ...
  EXPECT_HEX(
      "010E00500000000100303FEECCCC0000000000000000000000000000000008000"
...
TEST(encoder, flowmodv1_2) {
  ...
  EXPECT_HEX(
      "010E00580000000100303F8ECCCC0000000000000000000000000000000008000"
...
TEST(encoder, flowremovedv1) {
  ...
  EXPECT_EQ(0x58, encoder.size());
  EXPECT_HEX(
      "010B005811111111003FFFFE56780000000000000000000000000000000000000"
