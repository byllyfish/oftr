...
TEST(mpflowstatsreply, test1_v4) {
  ...
  EXPECT_HEX("00381100222222223333333344445555666677770000000088888888888888889"
...
TEST(mpflowstatsreply, test2_v4) {
  ...
  EXPECT_EQ(0x58, channel.size());
  EXPECT_HEX("00581100222222223333333344445555666677770000000088888888888888889"
             "999999999999999AAAAAAAAAAAAAAAA0001000C8000000400000007000000000004001800"
