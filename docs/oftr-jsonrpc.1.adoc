...
*cacert*:: Trusted PEM root certificate. One certificate, not a list.

*privkey*: PEM private key, possibly encrypted with a password.

*password*:: Password for PEM private key, if needed. (Optional)
