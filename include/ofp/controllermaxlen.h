...
public:
    ...
    constexpr operator OFPControllerMaxLen() const { return static_cast<OFPControllerMaxLen>(value()); }

    bool operator==(const ControllerMaxLen &rhs) const { return maxlen_ == rhs.maxlen_; }
