...
enum ofp_bad_action_code {
  ...
  OFPBAC_MATCH_INCONSISTENT = 10,  // Action can't apply for this match, or
                                   // Set-Field missing prerequisite.
...
enum ofp_bad_match_code {
  ...
  OFPBMC_BAD_MASK = 8,  // Unsupported mask specified in the match, field is not
                        // dl-address or nw-address.
...
enum ofp_group_mod_failed_code {
  ...
  OFPGMFC_INVALID_GROUP =
      1,  // Group not added because Group specified is invalid.
...
enum ofp_meter_mod_failed_code {
  ...
  OFPMMFC_METER_EXISTS = 1,  // Meter not added because a Meter ADD attempted to
