...
public:
    ...
    explicit OXMRegister(OXMType type): type_{type}, offset_{0}, nbits_{maxBits()} {
    }
    explicit OXMRegister(OXMType type, UInt16 offset, UInt16 nbits) : type_{type}, offset_{offset}, nbits_{nbits} {
    }
