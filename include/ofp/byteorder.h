...
public:
  ...
  constexpr Big24(UInt32 n) : n_{UInt8_narrow_cast((n >> 16) & 0xFF), UInt8_narrow_cast((n >> 8) & 0xFF), UInt8_narrow_cast(n & 0xFF)} {}

  constexpr operator UInt32() const { return (UInt32_cast(n_[0]) << 16) | (UInt32_cast(n_[1]) << 8) | UInt32_cast(n_[2]); }
