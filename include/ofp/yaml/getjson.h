...
bool getjson(std::istream &input, std::string &json, int &lineNum, int &newlineCount);
...
bool getyaml(std::istream &input, std::string &yaml, int &lineNum, int &newlineCount);

/// Read the next non-empty line from the input stream. 

bool getline(std::istream &input, std::string &line, int &lineNum, int &newlineCount);
