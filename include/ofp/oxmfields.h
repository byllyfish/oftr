...
using OFB_IN_PHY_PORT = OXMValue<OXMInternalID::OFB_IN_PHY_PORT,0x8000,1,Big32,4,false,&OXMPrereq_OFB_IN_PHY_PORT>;

/// \brief Table metadata. Used to pass information between tables.
using OFB_METADATA = OXMValue<OXMInternalID::OFB_METADATA,0x8000,2,Big64,8,true>;

/// \brief Ethernet destination MAC address.
using OFB_ETH_DST = OXMValue<OXMInternalID::OFB_ETH_DST,0x8000,3,EnetAddress,6,true>;

/// \brief Ethernet source MAC address.
using OFB_ETH_SRC = OXMValue<OXMInternalID::OFB_ETH_SRC,0x8000,4,EnetAddress,6,true>;

/// \brief Ethernet type of the OpenFlow packet payload, after VLAN tags.
using OFB_ETH_TYPE = OXMValue<OXMInternalID::OFB_ETH_TYPE,0x8000,5,Big16,2,false>;

/// \brief VLAN-ID from 802.1Q header. The CFI bit indicates the presence of a valid VLAN-ID.
using OFB_VLAN_VID = OXMValue<OXMInternalID::OFB_VLAN_VID,0x8000,6,Big16,2,true>;

/// \brief VLAN-PCP from 802.1Q header.
using OFB_VLAN_PCP = OXMValue<OXMInternalID::OFB_VLAN_PCP,0x8000,7,Big8,1,false,&OXMPrereq_OFB_VLAN_PCP>;

/// \brief DiffServ Code Point (DSCP). Part of the IPv4 ToS field or the IPv6 Traffic Class field.
using OFB_IP_DSCP = OXMValue<OXMInternalID::OFB_IP_DSCP,0x8000,8,Big8,1,false,&OXMPrereq_OFB_IP_DSCP>;

/// \brief ECN bits of the IP header. Part of the IPv4 ToS field or the IPv6 Traffic Class field.
using OFB_IP_ECN = OXMValue<OXMInternalID::OFB_IP_ECN,0x8000,9,Big8,1,false,&OXMPrereq_OFB_IP_ECN>;

/// \brief IPv4 or IPv6 protocol number.
using OFB_IP_PROTO = OXMValue<OXMInternalID::OFB_IP_PROTO,0x8000,10,Big8,1,false,&OXMPrereq_OFB_IP_PROTO>;

/// \brief IPv4 source address. Can use subnet mask or arbitrary bitmask.
using OFB_IPV4_SRC = OXMValue<OXMInternalID::OFB_IPV4_SRC,0x8000,11,IPv4Address,4,true,&OXMPrereq_OFB_IPV4_SRC>;

/// \brief IPv4 destination address. Can use subnet mask or arbitrary bitmask.
using OFB_IPV4_DST = OXMValue<OXMInternalID::OFB_IPV4_DST,0x8000,12,IPv4Address,4,true,&OXMPrereq_OFB_IPV4_DST>;

using OFB_TCP_SRC = OXMValue<OXMInternalID::OFB_TCP_SRC,0x8000,13,Big16,2,false,&OXMPrereq_OFB_TCP_SRC>;

using OFB_TCP_DST = OXMValue<OXMInternalID::OFB_TCP_DST,0x8000,14,Big16,2,false,&OXMPrereq_OFB_TCP_DST>;

using OFB_UDP_SRC = OXMValue<OXMInternalID::OFB_UDP_SRC,0x8000,15,Big16,2,false,&OXMPrereq_OFB_UDP_SRC>;

using OFB_UDP_DST = OXMValue<OXMInternalID::OFB_UDP_DST,0x8000,16,Big16,2,false,&OXMPrereq_OFB_UDP_DST>;

using OFB_SCTP_SRC = OXMValue<OXMInternalID::OFB_SCTP_SRC,0x8000,17,Big16,2,false,&OXMPrereq_OFB_SCTP_SRC>;

using OFB_SCTP_DST = OXMValue<OXMInternalID::OFB_SCTP_DST,0x8000,18,Big16,2,false,&OXMPrereq_OFB_SCTP_DST>;

using OFB_ICMPV4_TYPE = OXMValue<OXMInternalID::OFB_ICMPV4_TYPE,0x8000,19,Big8,1,false,&OXMPrereq_OFB_ICMPV4_TYPE>;

using OFB_ICMPV4_CODE = OXMValue<OXMInternalID::OFB_ICMPV4_CODE,0x8000,20,Big8,1,false,&OXMPrereq_OFB_ICMPV4_CODE>;

using OFB_ARP_OP = OXMValue<OXMInternalID::OFB_ARP_OP,0x8000,21,Big16,2,false,&OXMPrereq_OFB_ARP_OP>;

using OFB_ARP_SPA = OXMValue<OXMInternalID::OFB_ARP_SPA,0x8000,22,IPv4Address,4,true,&OXMPrereq_OFB_ARP_SPA>;

using OFB_ARP_TPA = OXMValue<OXMInternalID::OFB_ARP_TPA,0x8000,23,IPv4Address,4,true,&OXMPrereq_OFB_ARP_TPA>;

using OFB_ARP_SHA = OXMValue<OXMInternalID::OFB_ARP_SHA,0x8000,24,EnetAddress,6,true,&OXMPrereq_OFB_ARP_SHA>;

using OFB_ARP_THA = OXMValue<OXMInternalID::OFB_ARP_THA,0x8000,25,EnetAddress,6,true,&OXMPrereq_OFB_ARP_THA>;

using OFB_IPV6_SRC = OXMValue<OXMInternalID::OFB_IPV6_SRC,0x8000,26,IPv6Address,16,true,&OXMPrereq_OFB_IPV6_SRC>;

using OFB_IPV6_DST = OXMValue<OXMInternalID::OFB_IPV6_DST,0x8000,27,IPv6Address,16,true,&OXMPrereq_OFB_IPV6_DST>;

using OFB_IPV6_FLABEL = OXMValue<OXMInternalID::OFB_IPV6_FLABEL,0x8000,28,Big32,4,true,&OXMPrereq_OFB_IPV6_FLABEL>;

using OFB_ICMPV6_TYPE = OXMValue<OXMInternalID::OFB_ICMPV6_TYPE,0x8000,29,Big8,1,false,&OXMPrereq_OFB_ICMPV6_TYPE>;

using OFB_ICMPV6_CODE = OXMValue<OXMInternalID::OFB_ICMPV6_CODE,0x8000,30,Big8,1,false,&OXMPrereq_OFB_ICMPV6_CODE>;

using OFB_IPV6_ND_TARGET = OXMValue<OXMInternalID::OFB_IPV6_ND_TARGET,0x8000,31,IPv6Address,16,false,&OXMPrereq_OFB_IPV6_ND_TARGET>;

using OFB_IPV6_ND_SLL = OXMValue<OXMInternalID::OFB_IPV6_ND_SLL,0x8000,32,EnetAddress,6,false,&OXMPrereq_OFB_IPV6_ND_SLL>;

using OFB_IPV6_ND_TLL = OXMValue<OXMInternalID::OFB_IPV6_ND_TLL,0x8000,33,EnetAddress,6,false,&OXMPrereq_OFB_IPV6_ND_TLL>;

using OFB_MPLS_LABEL = OXMValue<OXMInternalID::OFB_MPLS_LABEL,0x8000,34,Big32,4,false,&OXMPrereq_OFB_MPLS_LABEL>;

using OFB_MPLS_TC = OXMValue<OXMInternalID::OFB_MPLS_TC,0x8000,35,Big8,1,false,&OXMPrereq_OFB_MPLS_TC>;

using OFP_MPLS_BOS = OXMValue<OXMInternalID::OFP_MPLS_BOS,0x8000,36,Big8,1,false,&OXMPrereq_OFP_MPLS_BOS>;

using OFB_PBB_ISID = OXMValue<OXMInternalID::OFB_PBB_ISID,0x8000,37,Big32,4,true,&OXMPrereq_OFB_PBB_ISID>;

using OFB_TUNNEL_ID = OXMValue<OXMInternalID::OFB_TUNNEL_ID,0x8000,38,Big64,8,true>;

using OFB_IPV6_EXTHDR = OXMValue<OXMInternalID::OFB_IPV6_EXTHDR,0x8000,39,Big16,2,true,&OXMPrereq_OFB_IPV6_EXTHDR>;
