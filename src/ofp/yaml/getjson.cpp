...
static void scanDoubleQuotes(std::istream &input, std::string &json, int &newlineCount) {
    char ch;
...
static void scanObject(std::istream &input, std::string &json, int &newlineCount) {
    int brace = 1;
...
bool ofp::yaml::getjson(std::istream &input, std::string &json, int &lineNum, int &newlineCount) {
    json.clear();
    lineNum = -1;
...
bool ofp::yaml::getyaml(std::istream &input, std::string &yaml, int &lineNum, int &newlineCount) {
  int msgSize = 0;
  std::string lineBuf;
...
bool ofp::yaml::getline(std::istream &input, std::string &line, int &lineNum, int &newlineCount) {
    std::string lineBuf;
