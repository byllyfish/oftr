...
static std::string stringJoin(const std::vector<llvm::StringRef> &vec, const char *sep);
...
std::string Schema::MakeSchemaString(const char *const name, const std::vector<llvm::StringRef> &values, size_t size) {
...
static std::string unsignedTypeEnum(size_t size) {
  switch (size) {
    case 1: return "0xHH";
    case 2: return "0xHHHH";
    case 4: return "0xHHHHHHHH";
    case 8: return "0xHHHHHHHHHHHHHHHH";
    default: return "0x__";
  }
}
