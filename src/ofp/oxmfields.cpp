...
static const ofp::UInt8 data_OFB_TCP_SRC[5]={128,0,20,1,6,};
const ofp::OXMRange ofp::OXMPrereq_OFB_TCP_SRC{data_OFB_TCP_SRC,5};
static const ofp::UInt8 data_OFB_TCP_DST[5]={128,0,20,1,6,};
const ofp::OXMRange ofp::OXMPrereq_OFB_TCP_DST{data_OFB_TCP_DST,5};
static const ofp::UInt8 data_OFB_UDP_SRC[5]={128,0,20,1,17,};
const ofp::OXMRange ofp::OXMPrereq_OFB_UDP_SRC{data_OFB_UDP_SRC,5};
static const ofp::UInt8 data_OFB_UDP_DST[5]={128,0,20,1,17,};
const ofp::OXMRange ofp::OXMPrereq_OFB_UDP_DST{data_OFB_UDP_DST,5};
static const ofp::UInt8 data_OFB_SCTP_SRC[5]={128,0,20,1,132,};
const ofp::OXMRange ofp::OXMPrereq_OFB_SCTP_SRC{data_OFB_SCTP_SRC,5};
static const ofp::UInt8 data_OFB_SCTP_DST[5]={128,0,20,1,132,};
const ofp::OXMRange ofp::OXMPrereq_OFB_SCTP_DST{data_OFB_SCTP_DST,5};
static const ofp::UInt8 data_OFB_ICMPV4_TYPE[5]={128,0,20,1,1,};
const ofp::OXMRange ofp::OXMPrereq_OFB_ICMPV4_TYPE{data_OFB_ICMPV4_TYPE,5};
static const ofp::UInt8 data_OFB_ICMPV4_CODE[5]={128,0,20,1,1,};
const ofp::OXMRange ofp::OXMPrereq_OFB_ICMPV4_CODE{data_OFB_ICMPV4_CODE,5};
...
static const ofp::UInt8 data_OFB_ICMPV6_TYPE[5]={128,0,20,1,58,};
const ofp::OXMRange ofp::OXMPrereq_OFB_ICMPV6_TYPE{data_OFB_ICMPV6_TYPE,5};
static const ofp::UInt8 data_OFB_ICMPV6_CODE[5]={128,0,20,1,58,};
const ofp::OXMRange ofp::OXMPrereq_OFB_ICMPV6_CODE{data_OFB_ICMPV6_CODE,5};
static const ofp::UInt8 data_OFB_IPV6_ND_TARGET[10]={128,0,58,1,135,128,0,58,1,136,};
const ofp::OXMRange ofp::OXMPrereq_OFB_IPV6_ND_TARGET{data_OFB_IPV6_ND_TARGET,10};
static const ofp::UInt8 data_OFB_IPV6_ND_SLL[5]={128,0,58,1,135,};
const ofp::OXMRange ofp::OXMPrereq_OFB_IPV6_ND_SLL{data_OFB_IPV6_ND_SLL,5};
static const ofp::UInt8 data_OFB_IPV6_ND_TLL[5]={128,0,58,1,136,};
const ofp::OXMRange ofp::OXMPrereq_OFB_IPV6_ND_TLL{data_OFB_IPV6_ND_TLL,5};
